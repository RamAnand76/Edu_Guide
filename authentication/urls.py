...
from .views import RegisterView, LoginView, LogoutView, AdminLoginView, StaffLoginView, PromoteToStaffView, PromoteToAdminView, RemoveFromStaffView, RemoveFromAdminView
